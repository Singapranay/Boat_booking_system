  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="images/speedboat-320088_640.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <span class="text-serif text-primary">About Us</span>
            <h3 class="heading-92913 text-black">Welcome To Our Website</h3>
            <p>Welcome to Boat Booking System, your one-stop destination for easy and reliable boat bookings! Whether you're planning a peaceful getaway or an exciting adventure, we offer a wide selection of boats to suit every need. With a user-friendly platform and exceptional customer support, we’re here to make your water journey unforgettable. Explore, book, and set sail with us!</p>
...
?>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/speedboat-320088_640.jpg');">
      <div class="container">
